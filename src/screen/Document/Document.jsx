...
function Document() {
  ...
  const [prev, setPrevURL] = useState('https://images.unsplash.com/photo-1483546416237-76fd26bbcdd1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bm90ZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60')
  ...
  return (
    <div className='row mx-0'>
        <div className="col-md-3 dark text-light border-end border-secondary vh-100">
          ...
          <div>
            <div className='m-3 fs-4 fw-bold'>Software Engineering</div>
          </div>
            <div className='m-3' onChange={editTitle}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16"> <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/></svg>
            </div>
          </div>
          <div className='desc mx-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim culpa at quasi dicta eius beatae amet animi molestias magni optio non quae repudiandae laboriosam</div>
          ...
          </div>
          {
            ...
            (
              ...
              <div className='row'>
                ...
                <div className='fs-6 text-end content' onClick={()=>setShowContent(true)}>Content</div>
                </div>
                <div className="col-md-6">
                <div className='fs-6 content' onClick={()=>setShowContent(false)}>Image</div>
                </div>
              </div>
              <div className='d-flex align-items-center justify-content-between my-1'>
                <div>Unit 2</div>
        ...
        <div className="col-md-9 m-0 mt-1">
          ...
          <div className='vh-100'>
            <textarea name="detail" className='textarea p-3'  onChange={contentChange}></textarea>
            <div className='d-flex justify-content-between'>
              <button className='btn btn-danger '>Delete the document</button>
            ...
            <div className='vh-100 '>
                <div className='textarea'>
                  ...
                  <img height='220px' onClick={previewShow} className='img-fluid' src="https://images.unsplash.com/photo-1483546416237-76fd26bbcdd1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bm90ZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60" alt="" />
                  </div>
                  <div className='col-md-3'>
                  <img height='220px' className='img-fluid' onClick={previewShow} src="https://images.unsplash.com/photo-1483546416237-76fd26bbcdd1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bm90ZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60" alt="" />
                    </div>
                  </div>
                </div>
                <div className='btn btn-success '>Add Image</div>
                {prevVisible &&
                ...
                <div className='preview p-2'>
                  ...
                  <div className='img'>
                  <img className='img-fluid img ' src="https://images.unsplash.com/photo-1483546416237-76fd26bbcdd1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZW" alt="" />
